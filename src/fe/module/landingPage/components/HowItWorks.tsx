...
export const HowItWorks: React.FC = () => {
  return (
    <section className="py-24 px-6 bg-white dark:bg-black overflow-hidden transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="mb-12">
              <span className="text-yellow-500 font-bold tracking-wider uppercase text-sm">How It Works</span>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                Protecting your privacy hasn't been this easy.
            ...
            <div className="mt-12 pt-12 border-t border-gray-100 dark:border-gray-800">
              <h4 className="font-bold text-gray-900 dark:text-white mb-6">Security Features</h4>
              <div className="flex flex-wrap gap-3">
                {SECURITY_FEATURES.map((feat, i) => (
                  <span key={i} className="px-4 py-2 rounded-full bg-gray-50 dark:bg-gray-900 text-gray-700 dark:text-gray-300 text-sm font-medium border border-gray-200 dark:border-gray-800 hover:border-yellow-400 transition-colors cursor-default">
                    ✓ {feat}
                  </span>
                ))}
              </div>
              ...
              <div className="bg-gray-800 dark:bg-gray-900 rounded-[2.5rem] p-8 md:p-12 border border-gray-700 dark:border-gray-800">
                <div className="bg-white dark:bg-black rounded-3xl p-6 shadow-2xl relative overflow-hidden">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-2">ContactKaro</h3>
                    <p className="text-sm text-gray-500 mb-6 font-mono">SECURE TAG ID</p>
                    ...
                    <div className="space-y-3 text-left">
                      <div className="p-4 rounded-xl bg-red-50 dark:bg-red-900/10 text-red-700 dark:text-red-400 border border-red-100 dark:border-red-900/20 flex items-center gap-3">
                        ...
                        <div>
                          <span className="block font-bold text-sm">Wrong Parking</span>
                          <span className="text-xs opacity-70">Scan to notify owner</span>
                        </div>
                      </div>
                      <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/10 text-blue-700 dark:text-blue-400 border border-blue-100 dark:border-blue-900/20 flex items-center gap-3">
                        ...
                        <div>
                          <span className="block font-bold text-sm">Contact Owner</span>
                          <span className="text-xs opacity-70">Privacy protected</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="mt-8 text-center">
                  <p className="text-gray-400 text-sm font-medium">
                    Scan the tag to instantly <br /> connect without sharing numbers.
                  </p>
                </div>
              </div>
            </div>
