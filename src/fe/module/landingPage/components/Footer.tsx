      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-500 text-sm mt-4 leading-relaxed">
                Privacy and Security at its Best. <br /> ContactKaro Vehicle Parking Tag.
              </p>
            </div>

            <div className="flex gap-4">
              {/* Social Icons from previous version */}
              <a href="#" className="w-10 h-10 rounded-full bg-gray-900 flex items-center justify-center text-gray-400 hover:bg-yellow-500 hover:text-black transition-all duration-300">
        ...
        <div className="border-t border-gray-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500">
            ...
            <a href="https://techv.in" target="_blank" rel="noreferrer" className="hover:text-yellow-400 transition-colors">
              Powered by TechV
            </a>
          </p>
          <div className="flex items-center gap-3 bg-gray-900 px-4 py-2 rounded-full border border-gray-800">
            ...
            <img
              ...
              alt="Amazon"
              className="h-4 grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100"
            />
          </div>
        </div>
      </div>
