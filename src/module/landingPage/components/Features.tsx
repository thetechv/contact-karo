...
export const Features: React.FC = () => {
  return (
    <section className="py-24 px-6 bg-gray-50 dark:bg-black transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          {FEATURES.map((feature) => (
            ...
            >
              {/* Hover Gradient */}
              <div className={`absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-yellow-400 to-yellow-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left`} />

              <div className="mb-6 relative">
                <div className={`w-16 h-16 rounded-2xl ${feature.iconBg} flex items-center justify-center text-3xl shadow-sm mb-6 group-hover:scale-110 transition-transform duration-300`}>
                  {feature.icon}
                </div>
